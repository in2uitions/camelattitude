...
export default function Home() {
    ...
    return (
        <div className="flex flex-col fixed justify-between overflow-y-visible overflow-x-hidden">
            ...
            <div className="grow">
                <div className="flex flex-row">
                    ...
                    <div className="flex flex-row h-screen ">
                        ...
                        <div className=" absolute flex flex-col h-screen w-screen overflow-y-visible overflow-x-hidden">
...
<div className=" w-screen absolute flex-fumer">
