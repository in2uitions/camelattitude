                            ...
                            <div className="basis-1/2">
                                ...
                                {nouvelleansObj.map((item) => (
                                    <>
                                        <div>
                                            <>
                                                <h2 className="margin-top-at attitude ml-6 text-7xl  transform -rotate-12 -translate-y-20" style={{ color: item.answers[0].text_color }} key={item.id}>{item.answers[0].attitude}</h2>
                                            </>
                                        </div>
                                    </>
                                ))}
